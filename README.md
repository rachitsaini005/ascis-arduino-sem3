...
Full write-up (introduction, objectives, circuit diagram, working principle, results, applications, references): [`ASCIS_Project_Report.pdf`](./ASCIS_Project_Report.pdf)
